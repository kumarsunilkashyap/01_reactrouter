...
export default function Contact() {
  ...
  const validate = () => {
    ...
    if (!formData.tel) tempErrors.tel = "Telephone number is required";
    return tempErrors;
  };
  ...
  return (
    <div className="relative flex items-top justify-center min-h-screen bg-gray-50 sm:items-center sm:pt-0">
